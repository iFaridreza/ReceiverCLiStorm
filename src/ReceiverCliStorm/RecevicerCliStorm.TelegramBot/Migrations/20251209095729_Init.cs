        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    DeviceModel = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    SystemVersion = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    AppVersion = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    LangCode = table.Column<string>(type: "TEXT", maxLength: 2, nullable: false),
                    SessionId = table.Column<long>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeviceAuthInfo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeviceAuthInfo_Session_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceAuthInfo_SessionId",
                table: "DeviceAuthInfo",
                column: "SessionId",
                unique: true);
